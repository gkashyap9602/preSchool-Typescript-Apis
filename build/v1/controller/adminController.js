...
let AdminController = class AdminController extends tsoa_1.Controller {
    ...
    New_Users(request) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const body = request;
                const { error, value } = adminvalidations_1.validations.newUserSchema.validate(request);
                if (error) {
                    throw new helperFun_1.error_Object(error.message.replace("/", ""), http_status_codes_1.default.UNPROCESSABLE_ENTITY);
                }
                ...
                const UserSaved = yield new index_1.AdminModels.ModelNewUser().save((err, success) => __awaiter(this, void 0, void 0, function* () {
                    if (err)
                        throw err;
    ...
    addCourse(request) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const { error, value } = adminvalidations_1.validations.newCourseSchema.validate(request);
                if (error) {
                    throw new helperFun_1.error_Object(error.message.replace(/[^a-zA-Z0-9_-]/g, ' '), http_status_codes_1.default.UNPROCESSABLE_ENTITY);
                }
                if (!Class_Data)
    ...
    Add_Student(request) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const body = request;
                const { error, value } = adminvalidations_1.validations.newStudentSchema.validate(request);
                if (error) {
                    throw new helperFun_1.error_Object(error.message.replace(/[^a-zA-Z0-9_-]/g, ' '), http_status_codes_1.default.UNPROCESSABLE_ENTITY);
                }
                ...
                const finduser = yield index_1.AdminModels.ModelNewStudent.findOne({
                    userId: body.userId,
