    ...
    New_Users(request) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!body)
                    throw new helperFun_1.error_Object("body is empty", 400);
                ...
                const UserSaved = yield new index_1.AdminModels.ModelNewUser(body).save();
                console.log(UserSaved, "Usersavedddd");
                if (!UserSaved)
                    throw new helperFun_1.error_Object("user not registered", 404);
                ...
                // });
                const mail = yield index_2.default.mailer(body.email, "Successfull Registration", `Hello ${UserSaved.fname + " " + UserSaved.lname} You are Registered Successfully`);
